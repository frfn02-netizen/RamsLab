...
export function getTrackingCollection():
  Collection<AlumniTracking> {
  return getDatabase().collection<AlumniTracking>(
    TRACKING_COLLECTION
  );
}

export async function findTrackingByAlumniId(
  alumniId: ObjectId
) {
