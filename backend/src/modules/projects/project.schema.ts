...
import { PROJECT_CATEGORY, PROJECT_STATUS } from "./project.types.js";

export const createProjectSchema = z.object({
  title: z.string().trim().min(3, "Project title is required").max(200),
  ...
  partnerIds: z.array(z.string()).max(50).default([]),
