...
export async function createPublicationIndexes() {
  ...
  await collection.createIndex(
    { year: -1, title: 1 },
    { name: "publications_year_title_index" },
  );
  await collection.createIndex(
    { doi: 1 },
    {
      ...
      name: "publications_doi_unique",
    },
  );
  await collection.createIndex(
    { normalizedTitle: 1, year: 1 },
    {
      unique: true,
      partialFilterExpression: { doi: null },
      name: "publications_title_year_without_doi_unique",
    },
  );
