...
const researchAreas: CreateResearchAreaInput[] = [
  {
    ...
    title: {
      en: "Risk Assessment & Safety",
      id: "Asesmen Risiko & Keselamatan",
    },
    description: {
    ...
    methods: {
      en: [
        ...
        "Safety analysis and consequence mapping",
        "Operational safeguards and decision support",
      ],
      id: [
        "Identifikasi bahaya dan asesmen risiko",
        "Analisis keselamatan dan pemetaan konsekuensi",
        "Pengaman operasional dan dukungan keputusan",
      ],
    },
    applications: {
      en: "HAZID · HAZOP · SAFETY CASES",
      id: "HAZID · HAZOP · SAFETY CASES",
    },
    order: 1,
    published: true,
  },
  {
    ...
    methods: {
      en: [
        "AIS data preparation and spatial analysis",
        "Maritime traffic patterns and monitoring",
        "Operational exposure and route insight",
      ],
      id: [
        "Penyiapan dan analisis spasial data AIS",
        "Pola lalu lintas dan pemantauan maritim",
        "Paparan operasional dan wawasan rute",
      ],
    },
    applications: {
      en: "TRAFFIC · MONITORING · MARITIME DATA",
      id: "LALU LINTAS · PEMANTAUAN · DATA MARITIM",
    },
    order: 2,
    published: true,
  },
  {
    ...
    title: {
      en: "Marine System Reliability & Availability",
      id: "Keandalan & Ketersediaan Sistem Maritim",
    },
    description: {
    ...
    methods: {
      en: [
        "FMEA, FTA, and reliability block modeling",
        "Availability and management analysis",
        "Lifecycle performance evaluation",
      ],
      id: [
        "Pemodelan FMEA, FTA, dan blok keandalan",
        "Analisis ketersediaan dan kemudahan pemeliharaan",
        "Evaluasi kinerja siklus hidup",
      ],
    },
    applications: {
      en: "FMEA · FTA · RELIABILITY BLOCKS",
      id: "FMEA · FTA · BLOK KEANDALAN",
    },
    order: 3,
    published: true,
  },
  {
    ...
    methods: {
      en: [
        ...
        "Preventive and condition-based strategies",
        "Maintenance planning and optimization",
      ],
      id: [
        "Analisis moda kegagalan dan kekritisan",
        "Strategi preventif dan berbasis kondisi",
        "Perencanaan dan optimasi pemeliharaan",
      ],
    },
    applications: {
      en: "RCM · FMEA · ASSET STRATEGY",
      id: "RCM · FMEA · STRATEGI ASET",
    },
    order: 4,
    published: true,
  },
  {
    ...
    title: {
      en: "Optimum Design of Industrial Facility",
      id: "Desain Optimum Fasilitas Industri",
    },
    description: {
    ...
    methods: {
      en: [
        "Facility layout and system configuration",
        "Lifecycle and performance trade-offs",
        "Industrial design decision support",
      ],
      id: [
        "Tata letak fasilitas dan konfigurasi sistem",
        "Trade-off siklus hidup dan kinerja",
        "Dukungan keputusan desain industri",
      ],
    },
    applications: {
      en: "LAYOUT · LIFECYCLE · OPTIMIZATION",
      id: "TATA LETAK · SIKLUS HIDUP · OPTIMASI",
    },
    order: 5,
    published: true,
  },
  {
    ...
    methods: {
      en: [
        "System behavior and capacity models",
        "Scenario comparison and sensitivity analysis",
        "Simulation-informed operations planning",
      ],
      id: [
        "Model perilaku dan kapasitas sistem",
        "Perbandingan skenario dan analisis sensitivitas",
        "Perencanaan operasi berbasis simulasi",
      ],
    },
    applications: {
      en: "DISCRETE EVENT · SYSTEMS · SCENARIOS",
      id: "PERISTIWA DISKRIT · SISTEM · SKENARIO",
    },
    order: 6,
    published: true,
  },
...
async function seedResearch() {
  ...
  for (const area of researchAreas) {
    const existing = await collection.findOne({
      $or: [{ code: area.code }, { slug: area.slug }],
    });
    if (existing) {
      await collection.updateOne(
        { _id: existing._id },
        { $set: { ...area, updatedAt: now } },
      );
