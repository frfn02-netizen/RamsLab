...
export default function ProfilePhotoField({ initialUrl, onFileChange, disabled = false, profileLabel = "profile" }: { initialUrl?: string; onFileChange: (file: File | null) => void; disabled?: boolean; profileLabel?: string }) {
