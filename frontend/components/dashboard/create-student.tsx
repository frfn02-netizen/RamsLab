...
export default function CreateStudent() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (photoFile) {
        await uploadStudentPhoto(student._id, photoFile);
      }
    ...
    <div className="p-5 sm:p-7 lg:p-9">
      <div className="mx-auto max-w-3xl space-y-7">
        ...
        <PageHeader
          eyebrow="People"
          title="Add student"
          description="Create a student profile and choose the directory category that represents the current academic status."
        />
          ...
          <form onSubmit={submit} className="space-y-5">
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <Field label="Program">
                <input
                  className={inputClass}
                  placeholder="Marine Engineering"
                  value={form.program}
            ...
            <Field label="Specializations">
              <input
                className={inputClass}
                placeholder="Reliability, Marine systems"
            ...
            <label className="flex items-center gap-3 text-sm font-semibold">
              ...
              />
              Publish this profile in the public People directory
            </label>
