    ...
    <>
      ...
      <section className="border-b border-[var(--navy-deep)] bg-[var(--navy)] py-16 text-white sm:py-20">
        <PublicContainer>
          ...
          <p className="mt-10 text-[0.75rem] font-bold uppercase tracking-[0.1em] text-[var(--rams-red)]">{t("heroEyebrow")}</p>
          <h1 className="mt-4 font-display text-4xl font-bold leading-tight tracking-[-0.02em] sm:text-5xl">{t("heroTitle")}</h1>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-white/70">{t("heroDescription")}</p>
          </div>
        </PublicContainer>
      </section>
          ...
          <aside className="space-y-10">
            <div className="border border-[#D9E0E6] bg-white">
              <div className="border-b border-[var(--border)] px-8 py-7">
                <h2 className="font-display text-2xl font-bold text-[var(--navy)]">{t("contactTitle")}</h2>
              ...
              <dl className="divide-y divide-[var(--border)]">
                ...
                <div className="px-8 py-6">
                  ...
                  <dd className="mt-3">
                    <a href="mailto:jtsp@its.ac.id" className="text-sm font-semibold text-[var(--rams-red)] transition hover:text-[var(--rams-red-dark)]">jtsp@its.ac.id</a>
                  </dd>
                </div>
                <div className="px-8 py-6">
                ...
                <div className="px-8 py-6">
                  ...
                  <dd className="mt-3 text-sm leading-6 text-[var(--navy)]">{t("socialText")}</dd>
                </div>
              </dl>
            </div>

            <div className="bg-[var(--navy)] p-8 text-white">
              <h3 className="font-display text-xl font-bold">{t("collaborationTitle")}</h3>
              <span className="mt-3 block h-0.5 w-10 bg-[var(--rams-red)]" aria-hidden="true" />
              <p className="mt-4 text-sm leading-6 text-white/70">{t("collaborationText")}</p>
