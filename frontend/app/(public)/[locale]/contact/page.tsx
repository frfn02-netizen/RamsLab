  ...
  return (
    <>
      ...
      <section className="border-b border-[var(--navy-deep)] bg-[var(--navy)] py-16 text-white sm:py-20">
        <PublicContainer>
          <div className="hero-entrance">
            ...
            <p className="mt-10 text-[0.75rem] font-bold uppercase tracking-[0.1em] text-[var(--rams-red)]">
              {localized(content.hero.eyebrow)}
            </p>

            <h1 className="mt-4 font-display text-4xl font-bold leading-tight tracking-[-0.02em] sm:text-5xl">
      ...
      <section className="bg-[var(--background-light)] py-16 sm:py-24">
        <PublicContainer>
          <RevealOnScroll
            className="grid items-start gap-10 lg:grid-cols-[3fr_2fr] lg:gap-16"
            stagger={120}
          >
            <ContactForm />
            ...
            <aside className="space-y-10">
              <div className="border border-[#D9E0E6] bg-white">
                <div className="border-b border-[var(--border)] px-8 py-7">
                  <h2 className="font-display text-2xl font-bold text-[var(--navy)]">
                    {localized(content.details.title)}
                  </h2>
                ...
                <dl className="divide-y divide-[var(--border)]">
                  ...
                  <div className="px-8 py-6">
                    ...
                    <dd className="mt-3">
                      <a
                        href={`mailto:${localized(content.details.email)}`}
                        className="text-sm font-semibold text-[var(--rams-red)] transition hover:text-[var(--rams-red-dark)]"
                      >
                        {localized(content.details.email)}
                      </a>
                    </dd>
                  </div>
                  ...
                  <div className="px-8 py-6">
                    ...
                    <dd className="mt-3 text-sm leading-6 text-[var(--navy)]">
                      {localized(content.details.socialText)}
                    </dd>
                  </div>
                </dl>
              </div>
              ...
              <div className="bg-[var(--navy)] p-8 text-white">
                <h3 className="font-display text-xl font-bold">
                  {localized(content.collaboration.title)}
                </h3>
                ...
                <p className="mt-4 text-sm leading-6 text-white/70">
                  {localized(content.collaboration.description)}
                </p>

                <Link
                  href="#contact-form"
                  className="mt-6 inline-block bg-[var(--rams-red)] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[var(--rams-red-dark)]"
                >
